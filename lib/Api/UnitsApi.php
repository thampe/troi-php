...
class UnitsApi
{
    ...
    /**
     * Operation miscUnitsGetWithHttpInfo
     *
     * Fetch all units
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['miscUnitsGet'] to see the possible values for this operation
    ...
    public function miscUnitsGetWithHttpInfo(string $contentType = self::contentTypes['miscUnitsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Troi\Model\ApiUnit[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Troi\Model\ApiUnit[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Troi\Model\ApiUnit[]', []),
    ...
    /**
     * Operation miscUnitsGetAsyncWithHttpInfo
     *
     * Fetch all units
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['miscUnitsGet'] to see the possible values for this operation
    ...
    /**
     * Operation miscUnitsIdGet
     *
     * Fetch unit given unit ID
     *
     * @param  int $id unit id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['miscUnitsIdGet'] to see the possible values for this operation
     *
     * @throws \Troi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Troi\Model\ApiUnit|\Troi\Model\AbsencesGet400Response|\Troi\Model\AbsencesGet401Response|\Troi\Model\AbsencesPost404Response
     */
    public function miscUnitsIdGet($id, string $contentType = self::contentTypes['miscUnitsIdGet'][0])
    {
        list($response) = $this->miscUnitsIdGetWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation miscUnitsIdGetWithHttpInfo
     *
     * Fetch unit given unit ID
     *
     * @param  int $id unit id (required)
     ...
     * @throws \Troi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Troi\Model\ApiUnit|\Troi\Model\AbsencesGet400Response|\Troi\Model\AbsencesGet401Response|\Troi\Model\AbsencesPost404Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function miscUnitsIdGetWithHttpInfo($id, string $contentType = self::contentTypes['miscUnitsIdGet'][0])
    {
        $request = $this->miscUnitsIdGetRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function miscUnitsIdGetAsync($id, string $contentType = self::contentTypes['miscUnitsIdGet'][0])
    {
        return $this->miscUnitsIdGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation miscUnitsIdGetAsyncWithHttpInfo
     *
     * Fetch unit given unit ID
     *
     * @param  int $id unit id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function miscUnitsIdGetAsyncWithHttpInfo($id, string $contentType = self::contentTypes['miscUnitsIdGet'][0])
    {
        $returnType = '\Troi\Model\ApiUnit';
        $request = $this->miscUnitsIdGetRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'miscUnitsIdGet'
     *
     * @param  int $id unit id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['miscUnitsIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function miscUnitsIdGetRequest($id, string $contentType = self::contentTypes['miscUnitsIdGet'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling miscUnitsIdGet'
            );
        }


        $resourcePath = '/misc/units/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
