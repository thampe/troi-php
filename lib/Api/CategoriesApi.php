...
class CategoriesApi
{
    ...
    /**
     * Operation miscCategoriesGet
     *
     * Fetch all Categories
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['miscCategoriesGet'] to see the possible values for this operation
     *
     * @throws \Troi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Troi\Model\ApiListItem[]|\Troi\Model\AbsencesGet400Response|\Troi\Model\AbsencesGet401Response
     */
    public function miscCategoriesGet(string $contentType = self::contentTypes['miscCategoriesGet'][0])
    {
        list($response) = $this->miscCategoriesGetWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation miscCategoriesGetWithHttpInfo
     *
     * Fetch all Categories
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['miscCategoriesGet'] to see the possible values for this operation
     ...
     * @throws \Troi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Troi\Model\ApiListItem[]|\Troi\Model\AbsencesGet400Response|\Troi\Model\AbsencesGet401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function miscCategoriesGetWithHttpInfo(string $contentType = self::contentTypes['miscCategoriesGet'][0])
    {
        $request = $this->miscCategoriesGetRequest($contentType);
    ...
    /**
     * Operation miscCategoriesGetAsync
     *
     * Fetch all Categories
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['miscCategoriesGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function miscCategoriesGetAsync(string $contentType = self::contentTypes['miscCategoriesGet'][0])
    {
        return $this->miscCategoriesGetAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation miscCategoriesGetAsyncWithHttpInfo
     *
     * Fetch all Categories
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['miscCategoriesGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function miscCategoriesGetAsyncWithHttpInfo(string $contentType = self::contentTypes['miscCategoriesGet'][0])
    {
        $returnType = '\Troi\Model\ApiListItem[]';
        $request = $this->miscCategoriesGetRequest($contentType);
    ...
    /**
     * Create request for operation 'miscCategoriesGet'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['miscCategoriesGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function miscCategoriesGetRequest(string $contentType = self::contentTypes['miscCategoriesGet'][0])
    {


        $resourcePath = '/misc/categories';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
