...
/**
 * CalculationPositionsPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Troi
 * @author   OpenAPI Generator team
 ...
 */
class CalculationPositionsPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_calculationPositions_post_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_external_service'] === null) {
            $invalidProperties[] = "'is_external_service' can't be null";
        }
     ...
     *
     * @param bool $is_external_service is_external_service
     *
     * @return self
     */
